            ...
            foreach (KeyValuePair<string, string> argument in arguments)
            {
                switch (argument.Key.ToLower())
                {
                    ...
                    case "not-after":
                        ...
                        {
                            // Swallowing this left the field at its default, and the
                            // validator then said "NotAfter is invalid" without ever
                            // mentioning that the FORMAT was the problem - which is a
                            // maze when the seconds are what you left off.
                            Logger.Error($"--not-after must be exactly \"yyyy-MM-dd HH:mm:ss\", got: '{argument.Value}'");
                        }
                        break;
                    case "not-before":
                        try
                        ...
                        {
                            // Swallowing this left the field at its default, and the
                            // validator then said "NotBefore is invalid" without ever
                            // mentioning that the FORMAT was the problem - which is a
                            // maze when the seconds are what you left off.
                            Logger.Error($"--not-before must be exactly \"yyyy-MM-dd HH:mm:ss\", got: '{argument.Value}'");
                        }
                        break;
                    case "password":
